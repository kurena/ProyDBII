...
<h3><i class="fa fa-angle-right"></i> Configuración Turnos</h3>
...
<div class="col-md-12 panel-body">
    <div class="col-lg-12">
        <div class="form-panel">
            <h4><i class="fa fa-angle-right"></i> Lista de Turnos</h4>
            <hr>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="turnoModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title"> Configuracíón de Turnos</h4>
            </div>
            <div class="modal-body" id="for_loop">
                <form class="form-horizontal style-form" onsubmit="return addModTurno(this)">
                    <div class="row form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Hora Entrada*</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="horEntrada" required="true">
                        </div>
                    </div>
                    <div class="row form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Hora Salida*</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="horSalida" required="true">
                        </div>
                    </div>
            </div>
...
<script src="assets/js/controllers/turno_controller.js"></script>
